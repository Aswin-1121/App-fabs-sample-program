...
class Window(QMainWindow):
    ...
    def __init__(self):
        ...
        # setting geometry
        self.setGeometry(280, 300, 360, 350)
    ...
    def UiComponents(self):
        ...
        # adding plus button a color effect
        c_effect = QGraphicsColorizeEffect()
        c_effect.setColor(Qt.red)
        push_plus.setGraphicsEffect(c_effect)
        ...
        # adding minus button a color effect
        c_effect = QGraphicsColorizeEffect()
        ...
        # adding mul button a color effect
        c_effect = QGraphicsColorizeEffect()
        c_effect.setColor(Qt.black)
        push_mul.setGraphicsEffect(c_effect)
        ...
        # adding div button a color effect
        c_effect = QGraphicsColorizeEffect()
        c_effect.setColor(Qt.darkBlue)
        push_div.setGraphicsEffect(c_effect)
